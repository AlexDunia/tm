...
<body>
    ...
    <br/>
        ...
        <form method="post" class="fstyle" action="{{route('rpp')}}" enctype="multipart/form-data">
            ...
            <div>
                <input id="email" class="nlstyle" type="text" name="token" hidden value={{$token}}>
            </div>
            ...
            <div>
                <input id="email" class="nlstyle" type="password" name="password" placeholder="New password">
                @error('password')
                <p class="inputeerror" style="color:rgb(252, 80, 80)"> {{$message}} </p>
                @enderror
            </div>
            ...
            <div>
                <input id="email" class="nlstyle" type="password" name="password_confirmation" placeholder="Confirm New Password">
            ...
            <br/>
                ...
                <button class="btncontact" type="submit"> Reset Password </button>
                  </div>
                </form>
